...
<?php /*%%SmartyHeaderCode:169367441353533572ba5e86-55539117%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '169367441353533572ba5e86-55539117',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_53533572c590a',
  'variables' => 
  array (
    'config' => 0,
    'logged_in' => 0,
...
<?php if ($_valid && !is_callable('content_53533572c590a')) {function content_53533572c590a($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
        ...
        <div id="wrapper" class="wat-cf">
            ...
            <div id="sidebar">
                <div class="block">
                  <h3>Navigation</h3>
                  <ul class="navigation">
                    <ul id="top_menu">						<li<?php if (isset($_smarty_tpl->tpl_vars['table_name']->value)){?><?php if ($_smarty_tpl->tpl_vars['table_name']->value=='Articles'){?> class='active'<?php }?><?php }?>><a href='articles'>Articles</a></li>
						<li<?php if (isset($_smarty_tpl->tpl_vars['table_name']->value)){?><?php if ($_smarty_tpl->tpl_vars['table_name']->value=='Users'){?> class='active'<?php }?><?php }?>><a href='users'>Users</a></li>
					</ul>
                  </ul>
                </div>
