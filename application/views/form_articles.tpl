        ...
        <div class="inner">
            ...
            <form class="form" method='post' action='articles/{$action_mode}/{if isset($record_id)}{$record_id}{/if}' enctype="multipart/form-data">
                ...
                <div class="group">
                    ...
                    <div>
                        <textarea class="text_field" id="input-content" cols="80" rows="20" value="{if isset($articles_data)}{$articles_data.content}{/if}" name="content" > </textarea>
                    </div>
                ...
                <div class="group">
                    ...
                    <div>
                        <input class="text_field" type="text" id="datepicker" maxlength="255" value="{if isset($articles_data)}{$articles_data.publication_date}{/if}" name="publication_date" />
                    </div>
